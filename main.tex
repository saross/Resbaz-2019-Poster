...
\renewcommand\TP@maketitle{%
   \centering
    \tikz[remember picture,overlay]\node[scale=0.8,anchor=east,xshift=0.46\linewidth,yshift=2.45cm,inner sep=0pt] {%
       \@titlegraphic
    };
   \begin{minipage}[b]{0.8\linewidth}
        ...
        { \@institute}
    \end{minipage}%
     \tikz[remember picture,overlay]\node[scale=0.8,anchor=east,xshift=0.18\linewidth,yshift=2.45cm,inner sep=0pt] {%
